                    ...
                    <form @submit.prevent="viewJob()">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <h4><b>ID:</b> {{form.id}} | <b>Status:</b> {{form.status}} | <a href="#"
                                        @click.prevent="hideJob(form.id)">
                                ...
                                <span v-for="job_meta in form.job_metas" :key="job_meta.key">
                                    ...
                                    <span v-else-if="job_meta.key === 'helpersRequired'">
                                        <p><b>{{job_meta.key | unCamelCase}}:</b> {{job_meta.value | helpersRequired}}
                                        </p>
                                        <hr>
                                    </span>
                                    <span v-else-if="job_meta.key === 'movingDate'">
                                        <p><b>{{job_meta.key | unCamelCase}}:</b> {{job_meta.value | isoDateToString}}
                                        </p>
                                        <hr>
                                    </span>
                                    <span v-else-if="job_meta.key === 'totalTime'">
                                        <p><b>{{job_meta.key | unCamelCase}}:</b>
                                            {{job_meta.value | timeInFloatToSec | timeInHoursMinutes}}</p>
                                        <hr>
                                    </span>
                                    ...
                                    <span v-else-if="job_meta.key === 'additionalTimePrice'">
                                        <p><b>{{job_meta.key | unCamelCase}}:</b> {{job_meta.value | currency}} per half
                                            hour </p>
                                        <hr>
                                    </span>
                                </span>
                ...
                <div class="modal-content">
                    <form @submit.prevent="editMode ? editFeedback() : newFeedback()">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Stars</label>
                                <input v-model="form.feedback.stars" type="number" min="1" max="5" step="1"
                                    name="feedback.stars" class="form-control"
                            ...
                            <div class="form-group">
                                <label>Comment</label>
                                <textarea v-model="form.feedback.comment" type="textarea" name="feedback.comment"
                                    class="form-control" :class="{ 'is-invalid': form.errors.has('feedback.comment') }"
                                    rows="3"></textarea>
